เข้าใจแล้วครับ! คือต้องการคัดเอาเฉพาะ **โค้ดเพียว ๆ (ไม่มีข้อความอธิบายใด ๆ เพิ่มเติมข้างนอกกล่องโค้ด)** เพื่อให้คุณนำไปคัดลอกและรันใช้งานได้ทันที

นี่คือโค้ดตัวเต็มทั้งหมดครับ:
