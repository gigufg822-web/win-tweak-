...
// Import API from ntdll to enable 0.5ms Timer Resolution
...
$btnRun.Add_Click({
    ...
    try {
        $lblStatus.Text = "PROCESSING..."; $lblStatus.ForeColor = [System.Drawing.Color]::Yellow; 
        ...
        if ($rbApply.Checked) {
            ...
            # =============================================================
            # --- [NEW] Deep Timer Resolution tweaks ---
            # =============================================================
            New-ItemProperty "HKLM:\SYSTEM\CurrentControlSet\Control\Session Manager\Kernel" -Name "GlobalTimerResolutionRequests" -Value 1 -PropertyType DWord -Force | Out-Null
            ...
            # --- Restore Timer Resolution system on RESET ---
